...
public class Exercises {
	...
	public String nonStart(String a, String b) {
		...
		return strA.deleteCharAt(0) + strB.deleteCharAt(0).toString();
	}
	...
	public String theEnd(String str, boolean front) {
		return front ? String.valueOf(str.charAt(0)) : str.substring(str.length() - 1);
	}
	...
	public boolean hasBad(String str) {
		if (str.contains("bad")) {
			return str.startsWith("xb") || str.startsWith("bad");
		}
		return false;
	}
	...
	public String frontTimes(String str, int n) {
		...
		return str.substring(0, str.length() / 2 - 1).repeat(n);
	}
